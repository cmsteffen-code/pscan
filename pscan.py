...
from scapy.all import ICMP, IP, TCP, AsyncSniffer, Ether, conf, sendp, sr1
...
TOP_1000 = (  # The top 1000 ports according to nmap.
    ...
    "3005-3007,3011,3013,3017,3030-3031,3052,3071,3077,3128,3168,3211,3221,3"
    "260-3261,3268-3269,3283,3300-3301,3306,3322-3325,3333,3351,3367,"
    ...
    "45100,48080,49152-49161,49163,49165,49167,49175-49176,49400,49999-50003,"
    "50006,50300,50389,50500,50636,50800,51103,51493,52673,52822,52848,52869,"
    "54045,54328,55055-55056,55555,55600,56737-56738,57294,57797,58080,60020,"
...
def syn_spray(host, ports):
    ...
    conf.verb = 0
    packets = [
        Ether() / IP(dst=host) / TCP(dport=port, flags="S") for port in ports
    ]
    sendp(packets)
